...
/*function printVals() {
 ...
 "act", "ace", "abs", "aim", "ago", "ape", "app", "bag",
 "bad", "bat", "bee", "bar", "bun", "car", "cap", "cop", "cat", "duo", 
 "dig", "dip", "ego", "egg", "elf", "fry", "fog", "foe", "fur", "fry",
 "gag", "gap", "gas", "gel", "get", "gig", "got", "gum", "gut", "had",
 "ham", "hue", "icy", "imp", "ion", "jam", "jar", "jet", "jog", "joy",
 "kid", "key", "kin", "lab", "lag", "lit", "low", "map", "man", "mat",
 "mix", "new", "not", "nut", "old", "off", "odd", "oak", "oak", "ore", 
 "owe", "oat", "pad", "pal", "peg", "paw", "pen", "pup", "rap", "rat",
 "ran", "raw", "saw", "sum", "tam", "tab", "tee", "top", "toy", "use", 
 "van", "vow", "war", "was", "wax", "web", "wet", "wry", "zoo", "zip",]; //database !
